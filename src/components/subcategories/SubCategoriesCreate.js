			...
			<SimpleForm redirect="list">
				<Grid container spacing={2}>
					<Grid item xs={12} sm={12}>
						...
						<NumberInput label="Precio Unidad" source="price" min={1} step={0.5} validate={required()} />
						<NumberInput label="Precio por Mayor" source="priceGalore" min={1} step={0.5} validate={required()} />
