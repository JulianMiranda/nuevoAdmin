...
import {List, Datagrid, TextField, SimpleList, NumberField, EditButton} from 'react-admin';
		...
		>
			{isSmall ? (
				...
				<Datagrid rowClick="show">
					...
					<TextField label="Telf." source="user.phone" />
					<CustomBoolean label="Estado" source="status" />
					<TextField label="De" source="owner" />
